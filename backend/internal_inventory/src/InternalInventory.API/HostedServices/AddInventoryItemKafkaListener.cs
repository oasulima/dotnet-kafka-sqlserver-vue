...
public class AddInventoryItemKafkaListener : BackgroundService
{
    ...
    public AddInventoryItemKafkaListener(
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            using var consumer = new ConsumerBuilder<string, AddInternalInventoryItemRequest>(
                _consumerConfig
            )
                .SetValueDeserializer(new KafkaDeserializer<AddInternalInventoryItemRequest>())
                .Build();
    ...
    private void ProcessMessage(
        ConsumeResult<string, AddInternalInventoryItemRequest> consumeResult
    )
    {
