...
public interface ILocatorService
{
    ...
    void ProcessProviderQuoteResponse(ProviderQuoteResponse providerQuoteResponse, string providerId);
    void AcceptQuote(QuoteRequest quote);
    void CancelQuote(QuoteRequest quote);
    void ProcessProviderBuyOrderResponse(ProviderBuyResponse providerBuyOrderResponse, string providerId);
